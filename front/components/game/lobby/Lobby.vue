<template>
  <div class="p-4 space-y-4">
    ...
    <button @click="onCreate"   class="btn">Create Party</button>
    <button @click="refreshList" class="btn">Join Party</button>
...
<script lang="ts">
  ...
  /**
  * Sert a emetre definir le mode de jeux, et une autre partie sert 
  * au back pour le matchmaking, mais l'online n'est pas encore dispo
  */
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      return { rooms, error, onCreate, onJoin, startLocal, startAI, refreshList };
    }
  });
</script>
